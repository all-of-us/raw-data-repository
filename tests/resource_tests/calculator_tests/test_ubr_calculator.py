...
class UBRCalculatorTest(BaseTestCase):
    ...
    def test_ubr_sexual_orientation(self):
        ...
        self.assertEqual(
            self.ubr.ubr_sexual_orientation('SexualOrientation_Lesbian,SexualOrientation_Straight'),
            UBRValueEnum.UBR)
        self.assertEqual(
            self.ubr.ubr_sexual_orientation('SexualOrientation_Straight,SexualOrientation_Lesbian'),
            UBRValueEnum.UBR)
