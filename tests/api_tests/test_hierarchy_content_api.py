...
class HierarchyContentApiTest(BaseTestCase):
    ...
    @mock.patch('rdr_service.dao.organization_hierarchy_sync_dao.OrganizationHierarchySyncDao.'
                '_get_time_zone')
    def test_create_new_site_new_payload(self, time_zone, lat_long):
        self._setup_data()
        lat_long.return_value = 100, 110
        time_zone.return_value = 'America/Los_Angeles'
        request_json = {
        ...
        request_json = {
            ...
            "extension": [
                ...
                },
                {
                    ...
                    "valueString": "<p>Good job! Now that you've finished \"The Basics\", Contact the <i>All of Us</i> PA team to complete the next steps in your enrollment process. To do this, please call your local <i>All of Us</i> PA team at <a href=\"800-664-0480\">800-664-0480</a> or go to <a href=\"https://joinallofuspa.org/onlinescheduling/overview\">https://joinallofuspa.org/onlinescheduling/overview</a> to schedule an enrollment visit online.</p>\n\t<br>\n\t<p>¡Bien hecho! Usted ha completado "
                    "Lo Básico"
                    ", llame al equipo de <i>All of Us</i> de Pennsylvania para completar los próximos pasos en su proceso de inscripción. Para hacer esto, por favor llame a su equipo de <i>All of Us</i> de Pennsylvania al <a href=\"800-664-0480\">800-664-0480</a> o visite <a href=\"https://joinallofuspa.org/onlinescheduling/overview\">https://joinallofuspa.org/onlinescheduling/overview</a> para programar su cita por Internet.</p>"
                },
                {
    ...
    def test_create_new_hpo_v2(self):
        self._setup_data()
        request_json = {
            "resourceType": "Organization",
