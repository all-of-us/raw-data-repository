...
TEST_AGE_BUCKET_DOB_DATE_OBJ = datetime.date(1985, 10, 9)
...
participant_summary_default_values = {
    ...
    "sampleOrderStatus1PS4A": "UNSET",
    "sampleOrderStatus1PS4B": "UNSET",
    "sampleOrderStatus2PS4A": "UNSET",
    "sampleOrderStatus2PS4B": "UNSET",
    ...
    "sampleStatus1PS4A": "UNSET",
    "sampleStatus1PS4B": "UNSET",
    "sampleStatus2PS4A": "UNSET",
    "sampleStatus2PS4B": "UNSET",
    ...
    "remoteIdVerificationOrigin": "UNSET",
    "remoteIdVerifiedOn": "UNSET",
    "everIdVerified": "UNSET",
    "firstIdVerifiedOn": "UNSET",
...
class ParticipantSummaryApiTest(BaseTestCase):
    ...
    def testQuery_ehrConsent(self):
        ...
        self.assertEqual(None, ps_1.get("enrollmentStatusParticipantPlusEhrV3_2Time"))
    ...
    def test_ehr_consent_after_dv_consent(self):
        ...
        # submit dv consent only, the enrollmentStatusParticipantPlusEhrV3_2Time should be TIME_1
        self._submit_dvehr_consent_questionnaire_response(
    ...
    def test_remote_id_verification(self):
        ...
        # load & send a response w/ no remote id verification
        ...
        # Get request from API to assert certain values stay UNSET
        ...
        self.assertEqual(summary['remoteIdVerificationOrigin'], UNSET)
        self.assertEqual(summary['remoteIdVerifiedOn'], UNSET)
        self.assertEqual(summary['everIdVerified'], UNSET)
        self.assertEqual(summary['firstIdVerifiedOn'], UNSET)
        self.assertEqual(summary['idVerificationOrigin'], UNSET)
        # load & send a True remote ID verification response
