...
class RetentionCalculationTest(BaseTestCase):
    ...
    def _build_retention_data(
        ...
        etm_consent_authored: datetime = None,
        wear_consent_authored: datetime = None,
        nph_consent_authored: datetime = None,
        ...
        default_data = RetentionEligibilityDependencies(
            ...
            nph_consent_timestamp=nph_consent_authored,
            etm_consent_timestamp=etm_consent_authored,
            wear_consent_timestamp=wear_consent_authored,
