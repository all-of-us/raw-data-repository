...
class GenomicStorageTest(BaseTestCase):
    ...
    @classmethod
    def test_generate_array_metric_files(cls, **kwargs) -> dict:
    ...
    def test_get_file_paths_from_metrics(self):
        num_metrics = 4
        ...
        for num in range(num_metrics):
            ...
            metric_data_files = self.test_generate_array_metric_files(prefix=member.sampleId)
        ...
        file_for_update = GenomicStorageClass.get_file_paths_from_metrics(all_metrics)
