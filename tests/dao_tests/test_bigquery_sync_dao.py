...
from rdr_service.participant_enums import SuspensionStatus, WithdrawalStatus
from rdr_service.test.test_data import load_measurement_json
from tests.helpers.unittest_base import BaseTestCase


class BigQuerySyncDaoTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        with clock.FakeClock(self.TIME_2):
            ...
            self.bio_order = BiobankOrderDao().insert(
                self._make_biobank_order(participantId=self.participant.participantId))
