...
function_name = 'genomic_aw1_northwest_function'
...
def get_deploy_args(gcp_env):
    ...
    if _project_suffix == 'stable':
        cloud_resource = 'genomics-northwest-dryrun'

    if _project_suffix == 'prod':
        cloud_resource = 'prod-genomics-northwest'
...
def genomic_aw1_northwest_function(_event, _context):
    """
