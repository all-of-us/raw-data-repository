...
function_name = 'genomic_aw1_jh_function'
...
def get_deploy_args(gcp_env):
    ...
    if _project_suffix == 'stable':
        cloud_resource = 'genomics-baylor-dryrun'

    if _project_suffix == 'prod':
        cloud_resource = 'prod-genomics-baylor'
...
def genomic_aw1_jh_function(_event, _context):
    """
