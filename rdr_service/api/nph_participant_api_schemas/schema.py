...
class Participant(ObjectType):
    ...
    first_name = Field(String, description='Participant’s first name, sourced from AoU participant_'
                                                             'summary table')
    middle_name = Field(String, description='Participant’s middle name, sourced from AoU '
    ...
    email = Field(String, description='Participant’s email address, sourced from AoU '
                                                    'participant_summary table')
    aou_aian_status = Field(Event, description='Provides whether a participant self identifies as'
    ...
    aou_basics_questionnaire = Field(Event,
                                     ...
                                     'table.')
    aou_deceased_status = Field(Event,
                                ...
                                'table.')
    aou_withdrawal_status = Field(Event,
                                  ...
                                  'participant_summary table.')
    aou_deactivation_status = Field(Event,
    ...
    aou_site = Field(String,
                     ...
                     'table.')
    aou_enrollment_status = Field(Event,
    ...
    aou_lifestyle_questionnaire = Field(Event,
                                        ...
                                        'authored time. Both should be sourced from the AoU '
                                        'participant_summary table.')
    aou_sdoh_questionnaire = Field(Event,
                                   description='Provides submission status and authored time for the '
