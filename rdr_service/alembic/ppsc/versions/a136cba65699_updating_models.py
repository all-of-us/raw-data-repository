...
def upgrade_ppsc():
    ...
    op.add_column('ppsc_biobank_sample',
                  sa.Column('first_time_date_time', rdr_service.model.utils.UTCDateTime6(fsp=6), nullable=True))
    op.add_column('ppsc_biobank_sample',
                  sa.Column('last_time_date_time', rdr_service.model.utils.UTCDateTime6(fsp=6), nullable=True))
    op.drop_column('ppsc_biobank_sample', 'first_time_date')
    op.drop_column('ppsc_biobank_sample', 'last_time_date')
    op.add_column('ppsc_core',
                  sa.Column('has_core_data_date_time', rdr_service.model.utils.UTCDateTime6(fsp=6), nullable=True))
    op.drop_column('ppsc_core', 'has_core_data_date')
    op.add_column('ppsc_ehr',
                  sa.Column('first_time_date_time', rdr_service.model.utils.UTCDateTime6(fsp=6), nullable=True))
    op.add_column('ppsc_ehr',
                  sa.Column('last_time_date_time', rdr_service.model.utils.UTCDateTime6(fsp=6), nullable=True))
    op.drop_column('ppsc_ehr', 'first_time_date')
    op.drop_column('ppsc_ehr', 'last_time_date')
    op.add_column('ppsc_health_data',
                  sa.Column('health_data_stream_sharing_status_date_time', rdr_service.model.utils.UTCDateTime6(fsp=6),
                            nullable=True))
...
def downgrade_ppsc():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('ppsc_health_data',
                  sa.Column('health_data_stream_sharing_status_date', mysql.DATETIME(fsp=6), nullable=True))
