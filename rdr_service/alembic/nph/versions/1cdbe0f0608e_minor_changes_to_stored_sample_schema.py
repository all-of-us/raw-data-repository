"""Minor changes to stored_sample schema

Revision ID: 1cdbe0f0608e
Revises: 25f0d3a691e6
Create Date: 2023-02-02 15:46:36.499076
...
revision = '1cdbe0f0608e'
down_revision = '25f0d3a691e6'
branch_labels = None
depends_on = None
...
def upgrade_nph():
    ...
    op.add_column('stored_sample', sa.Column('ignore_flag', mysql.TINYINT(), nullable=True))
    op.create_index(op.f('ix_nph_stored_sample_sample_id'), 'stored_sample', ['sample_id'], unique=False, schema='nph')
...
def downgrade_nph():
    ...
    op.drop_index(op.f('ix_nph_stored_sample_sample_id'), table_name='stored_sample', schema='nph')
    op.drop_column('stored_sample', 'ignore_flag')
    ...
    op.drop_constraint(None, 'pairing_event', schema='nph', type_='foreignkey')
    op.drop_constraint(None, 'pairing_event', schema='nph', type_='foreignkey')
    op.create_foreign_key('pairing_event_ibfk_2', 'pairing_event', 'participant', ['participant_id'], ['id'])
    op.create_foreign_key('pairing_event_ibfk_1', 'pairing_event', 'site', ['site_id'], ['id'])
    op.create_foreign_key('pairing_event_ibfk_3', 'pairing_event', 'pairing_event_type', ['event_type_id'], ['id'])
    op.create_foreign_key('pairing_event_ibfk_4', 'pairing_event', 'participant_event_activity', ['event_id'], ['id'])
    ...
    op.create_foreign_key('order_ibfk_1', 'order', 'site', ['collected_site'], ['id'])
    ...
    op.create_foreign_key('enrollment_event_ibfk_2', 'enrollment_event', 'enrollment_event_type', ['event_type_id'], ['id'])
    ...
    op.create_foreign_key('consent_event_ibfk_3', 'consent_event', 'participant', ['participant_id'], ['id'])
