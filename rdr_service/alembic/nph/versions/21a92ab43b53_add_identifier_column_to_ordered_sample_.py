"""add identifier column to ordered_sample model

Revision ID: 21a92ab43b53
Revises: 8f83ed949555
Create Date: 2023-01-06 16:57:30.791594
...
revision = '21a92ab43b53'
down_revision = '8f83ed949555'
branch_labels = None
depends_on = None
...
def upgrade_nph():
    ...
    op.add_column('ordered_sample', sa.Column('identifier', sa.String(length=128), nullable=True))
...
def downgrade_nph():
    ...
    op.drop_column('ordered_sample', 'identifier')
