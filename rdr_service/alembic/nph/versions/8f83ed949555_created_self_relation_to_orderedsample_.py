"""Created self-relation to OrderedSample/StudyCategory schema

Revision ID: 8f83ed949555
Revises: 3d8a93819825
Create Date: 2023-01-06 12:24:27.212462
...
revision = '8f83ed949555'
down_revision = '3d8a93819825'
branch_labels = None
depends_on = None
...
def downgrade_nph():
    ...
    op.create_foreign_key('order_ibfk_4', 'order', 'site', ['amended_site'], ['id'])
