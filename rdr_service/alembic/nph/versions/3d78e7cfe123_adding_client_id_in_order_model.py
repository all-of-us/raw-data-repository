"""adding client_id in Order model

Revision ID: 3d78e7cfe123
Revises: ceb85f930f63
Create Date: 2023-01-27 13:37:18.260874
...
revision = '3d78e7cfe123'
down_revision = 'ceb85f930f63'
branch_labels = None
depends_on = None
...
def upgrade_nph():
    ...
    op.add_column('order', sa.Column('client_id', sa.String(length=64), nullable=True))
...
def downgrade_nph():
    ...
    op.create_foreign_key('order_ibfk_2', 'order', 'site', ['amended_site'], ['id'])
    ...
    op.create_foreign_key('enrollment_event_ibfk_1', 'enrollment_event', 'participant_event_activity', ['event_id'], ['id'])
