...
Revision ID: 3d8a93819825
Revises: 9ec16dfbe3f9
Create Date: 2023-01-06 12:05:57.297988
...
def upgrade_nph():
    ...
    op.add_column('biobank_file_export', sa.Column('crc32c_checksum', sa.Integer(), nullable=False))
    op.alter_column('biobank_file_export', 'file_name',
               existing_type=mysql.VARCHAR(length=256),
               nullable=False)
    op.create_unique_constraint(None, 'biobank_file_export', ['crc32c_checksum'], schema='nph')
    op.add_column('order', sa.Column('ignore_flag', mysql.TINYINT(), nullable=True))
    ...
    op.add_column('sample_export', sa.Column('ignore_flag', mysql.TINYINT(), nullable=True))
    ...
    op.add_column('sample_update', sa.Column('ignore_flag', mysql.TINYINT(), nullable=True))
    op.add_column('sample_update', sa.Column('ordered_sample_json', mysql.JSON(), nullable=True))
...
def downgrade_nph():
    ...
    op.drop_column('sample_update', 'ordered_sample_json')
    op.drop_column('sample_update', 'ignore_flag')
    ...
    op.drop_column('sample_export', 'ignore_flag')
    ...
    op.drop_column('order', 'ignore_flag')
    op.drop_constraint(None, 'biobank_file_export', schema='nph', type_='unique')
    op.alter_column('biobank_file_export', 'file_name',
               existing_type=mysql.VARCHAR(length=256),
               nullable=True)
    op.drop_column('biobank_file_export', 'crc32c_checksum')
    # ### end Alembic commands ###
