"""Added volume field to ordered_sample table

Revision ID: 9ec16dfbe3f9
Revises: 3ee76718fe2b
Create Date: 2022-12-30 11:20:06.929567
...
revision = '9ec16dfbe3f9'
down_revision = '3ee76718fe2b'
branch_labels = None
depends_on = None
...
def upgrade_nph():
    ...
    op.add_column('ordered_sample', sa.Column('volume', sa.String(length=128), nullable=True))
...
def downgrade_nph():
    ...
    op.drop_column('ordered_sample', 'volume')
