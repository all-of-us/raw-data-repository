"""Add diversion_pouch_site_flag to genomic_set_member

Revision ID: 417a8c779994
Revises: 8e8e3911a2bd, a1b2e17c66ad
Create Date: 2022-04-19 13:47:52.917261
...
def upgrade_rdr():
    ...
    op.add_column('genomic_set_member', sa.Column('diversion_pouch_site_flag', sa.SmallInteger(), nullable=False))
    op.add_column('genomic_set_member_history', sa.Column('diversion_pouch_site_flag', sa.SmallInteger(), nullable=False))
    op.execute("""
...
NEW.diversion_pouch_site_flag <=> OLD.diversion_pouch_site_flag
                    );
...
def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('genomic_set_member', 'diversion_pouch_site_flag')
    op.drop_column('genomic_set_member_history', 'diversion_pouch_site_flag')
    op.execute("""
            DROP TRIGGER IF EXISTS genomic_set_member__ai;
            DROP TRIGGER IF EXISTS genomic_set_member__au;
            DROP TRIGGER IF EXISTS genomic_set_member__bd;
