...
def upgrade_rdr():
    ...
    op.add_column('participant_summary', sa.Column('sample_status_dv_1sal2', model.utils.Enum(SampleStatus), nullable=True))
    op.add_column('participant_summary', sa.Column('sample_status_dv_1sal2_time', model.utils.UTCDateTime(), nullable=True))
