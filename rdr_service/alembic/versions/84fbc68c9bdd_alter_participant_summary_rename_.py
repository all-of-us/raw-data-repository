...
from rdr_service.participant_enums import PhysicalMeasurementsStatus, SelfReportedPhysicalMeasurementsStatus
...
def upgrade_rdr():
    ...
    op.alter_column('participant_summary', 'physical_measurements_created_site_id',
                    new_column_name='clinic_physical_measurements_created_site_id',
                    existing_type=sa.Integer)
    op.alter_column('participant_summary', 'physical_measurements_finalized_site_id',
                    new_column_name='clinic_physical_measurements_finalized_site_id',
                    existing_type=sa.Integer)
    op.alter_column('participant_summary', 'physical_measurements_finalized_time',
                    new_column_name='clinic_physical_measurements_finalized_time',
                    existing_type=rdr_service.model.utils.UTCDateTime)
    op.alter_column('participant_summary', 'physical_measurements_status',
                    new_column_name='clinic_physical_measurements_status',
                    existing_type=rdr_service.model.utils.Enum(PhysicalMeasurementsStatus),
                    existing_default=PhysicalMeasurementsStatus.UNSET)
    op.alter_column('participant_summary', 'physical_measurements_time',
                    new_column_name='clinic_physical_measurements_time',
                    existing_type=rdr_service.model.utils.UTCDateTime)
    op.add_column('participant_summary', sa.Column('self_reported_physical_measurements_authored', rdr_service.model.utils.UTCDateTime(), nullable=True))
    op.add_column('participant_summary', sa.Column('self_reported_physical_measurements_status', rdr_service.model.utils.Enum(SelfReportedPhysicalMeasurementsStatus), nullable=True))
