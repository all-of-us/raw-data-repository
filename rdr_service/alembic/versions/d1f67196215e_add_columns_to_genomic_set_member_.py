...
def upgrade_rdr():
    ...
    op.execute('ALTER TABLE genomic_set_member_history ADD COLUMN biobank_order_client_Id varchar(80) AFTER `biobank_id`;')
    op.execute('ALTER TABLE genomic_set_member_history ADD COLUMN package_id varchar(80) AFTER `biobank_order_client_Id`;')
