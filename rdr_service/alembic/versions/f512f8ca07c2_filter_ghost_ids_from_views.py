"""filter_ghost_ids_from_views

Revision ID: f512f8ca07c2
Revises: 80327f136364
Create Date: 2019-05-21 16:34:40.838304
...
revision = 'f512f8ca07c2'
down_revision = '80327f136364'
branch_labels = None
depends_on = None
...
PARTICIPANT_VIEW = ReplaceableObject('particpant_view',
"""
 SELECT
   p.participant_id,
   p.sign_up_time,
...
RAW_PARTICIPANT_VIEW = ReplaceableObject('raw_ppi_participant_view',
"""
 SELECT
   p.participant_id,
   ps.last_name,
...
PPI_PARTICIPANT_VIEW = ReplaceableObject('ppi_participant_view',
"""
 SELECT
   p.participant_id,
...
def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
  op.drop_view(PPI_PARTICIPANT_VIEW)
  op.drop_view(RAW_PARTICIPANT_VIEW)
  op.drop_view(PARTICIPANT_VIEW)
