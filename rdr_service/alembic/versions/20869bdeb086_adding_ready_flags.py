...
Revision ID: 20869bdeb086
Revises: 8e8e3911a2bd, a1b2e17c66ad
Create Date: 2022-04-18 10:13:39.095844
...
def upgrade_rdr():
    ...
    op.add_column('genomic_set_member', sa.Column('informing_loop_ready_flag', sa.Integer(), nullable=False))
    op.add_column('genomic_set_member', sa.Column('informing_loop_ready_flag_modified', sa.DateTime(), nullable=True))
    op.add_column('genomic_set_member_history', sa.Column('informing_loop_ready_flag', sa.Integer(), nullable=False))
    op.execute("""
...
NEW.informing_loop_ready_flag_modified <=> OLD.informing_loop_ready_flag_modified
                    );
        ...
        """)
    op.add_column('genomic_set_member_history', sa.Column('informing_loop_ready_flag_modified', sa.DateTime(), nullable=True))
    op.execute("""
            DROP TRIGGER IF EXISTS genomic_set_member__ai;
            DROP TRIGGER IF EXISTS genomic_set_member__au;
            DROP TRIGGER IF EXISTS genomic_set_member__bd;
...
def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('genomic_set_member', 'informing_loop_ready_flag_modified')
    op.drop_column('genomic_set_member', 'informing_loop_ready_flag')
    op.drop_column('genomic_set_member_history', 'informing_loop_ready_flag_modified')
    op.execute("""
            DROP TRIGGER IF EXISTS genomic_set_member__ai;
            DROP TRIGGER IF EXISTS genomic_set_member__au;
            DROP TRIGGER IF EXISTS genomic_set_member__bd;
...
NEW.informing_loop_ready_flag_modified <=> OLD.informing_loop_ready_flag_modified
            ...
            CREATE TRIGGER genomic_set_member__bd BEFORE DELETE ON genomic_set_member FOR EACH ROW
                ...
                FROM genomic_set_member AS d WHERE d.id = OLD.id;
        """)
    op.drop_column('genomic_set_member_history', 'informing_loop_ready_flag')
    op.execute("""
            DROP TRIGGER IF EXISTS genomic_set_member__ai;
            DROP TRIGGER IF EXISTS genomic_set_member__au;
            DROP TRIGGER IF EXISTS genomic_set_member__bd;
