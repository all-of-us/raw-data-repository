...
def upgrade_rdr():
    ...
    op.execute(
        "ALTER TABLE metrics_enrollment_status_cache ADD COLUMN participant_origin VARCHAR(50);"
    )
    op.execute(
    ...
    op.execute(
        "ALTER TABLE metrics_gender_cache ADD COLUMN participant_origin VARCHAR(50);"
    )
    op.execute(
    ...
    op.execute(
        "ALTER TABLE metrics_age_cache ADD COLUMN participant_origin VARCHAR(50);"
    )
    op.execute(
    ...
    op.execute(
        "ALTER TABLE metrics_race_cache ADD COLUMN participant_origin VARCHAR(50);"
    )
    op.execute(
