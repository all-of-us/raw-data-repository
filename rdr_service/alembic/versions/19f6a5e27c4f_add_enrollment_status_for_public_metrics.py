...
def upgrade_rdr():
    ...
    op.execute('ALTER TABLE metrics_gender_cache ADD COLUMN enrollment_status VARCHAR(50) NOT NULL AFTER `date_inserted`;')
    op.execute('ALTER TABLE metrics_gender_cache DROP PRIMARY KEY')
    op.execute('ALTER TABLE metrics_gender_cache ADD PRIMARY KEY (`date_inserted`,`hpo_id`,`hpo_name`,`date`,`gender_name`,`enrollment_status`)')
