"""Add identifier and answer_hash to etm_questionnaire_response
...
def upgrade_rdr():
    ...
    op.add_column('etm_questionnaire_response', sa.Column('answer_hash', sa.String(length=32), nullable=True))
...
def downgrade_rdr():
    ...
    op.drop_column('etm_questionnaire_response', 'answer_hash')
    # ### end Alembic commands ###
