...
def upgrade_rdr():
    ...
    op.add_column('genomic_set_member', sa.Column('cvl_w2sc_file_processed_id', sa.Integer(), nullable=True))
    op.add_column('genomic_set_member', sa.Column('cvl_w2sc_manifest_job_run_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'genomic_set_member', 'genomic_file_processed', ['cvl_w2sc_file_processed_id'], ['id'])
...
def downgrade_rdr():
    ...
    op.drop_column('genomic_set_member', 'cvl_w2sc_file_processed_id')
    # ### end Alembic commands ###
