"""retention eligible import table

Revision ID: 813b74f84338
Revises: 99fb6b79b5f7
Create Date: 2021-01-13 10:21:24.311338
...
def upgrade_rdr():
    ...
    op.create_index(op.f('ix_retention_eligible_metrics_participant_id'), 'retention_eligible_metrics', ['participant_id'], unique=True)
