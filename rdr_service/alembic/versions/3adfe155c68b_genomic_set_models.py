...
from rdr_service.model.genomics import GenomicSetStatus, GenomicValidationStatus
...
def upgrade_rdr():
    ...
    op.create_table('genomic_set_member',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created', sa.DateTime(), nullable=True),
    sa.Column('modified', sa.DateTime(), nullable=True),
    ...
    op.alter_column('genomic_set', 'created', existing_type=mysql.DATETIME(fsp=6), nullable=True,
                    existing_server_default=sa.text('current_timestamp(6)'))
    op.alter_column('genomic_set', 'modified', existing_type=mysql.DATETIME(fsp=6), nullable=True,
                    existing_server_default=sa.text('current_timestamp(6) ON UPDATE current_timestamp(6)'))

    op.alter_column('genomic_set_member', 'created', existing_type=mysql.DATETIME(fsp=6),
                    nullable=True, existing_server_default=sa.text('current_timestamp(6)'))
    op.alter_column('genomic_set_member', 'modified', existing_type=mysql.DATETIME(fsp=6),
                    nullable=True, existing_server_default=sa.text(
                      'current_timestamp(6) ON UPDATE current_timestamp(6)'))

    op.alter_column('biobank_dv_order', 'created', existing_type=mysql.DATETIME(fsp=6),
               nullable=True, existing_server_default=sa.text('current_timestamp(6)'))
    op.alter_column('biobank_dv_order', 'modified', existing_type=mysql.DATETIME(fsp=6), nullable=True,
                    existing_server_default=sa.text('current_timestamp(6) ON UPDATE current_timestamp(6)'))
...
def downgrade_rdr():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('genomic_set', 'modified', existing_type=mysql.DATETIME(fsp=6), nullable=False,
                    existing_server_default=sa.text('current_timestamp(6) ON UPDATE current_timestamp(6)'))
    op.alter_column('genomic_set', 'created', existing_type=mysql.DATETIME(fsp=6), nullable=False,
                    existing_server_default=sa.text('current_timestamp(6)'))

    op.alter_column('genomic_set_member', 'modified', existing_type=mysql.DATETIME(fsp=6), nullable=False,
                    existing_server_default=sa.text('current_timestamp(6) ON UPDATE current_timestamp(6)'))
    op.alter_column('genomic_set_member', 'created', existing_type=mysql.DATETIME(fsp=6), nullable=False,
                    existing_server_default=sa.text('current_timestamp(6)'))

    op.alter_column('biobank_dv_order', 'modified', existing_type=mysql.DATETIME(fsp=6), nullable=False,
               existing_server_default=sa.text('current_timestamp(6) ON UPDATE current_timestamp(6)'))
    op.alter_column('biobank_dv_order', 'created', existing_type=mysql.DATETIME(fsp=6), nullable=False,
               existing_server_default=sa.text('current_timestamp(6)'))
