...
Revision ID: 1338221caf81
Revises: 648d99c5c414
Create Date: 2019-03-11 13:27:09.071999
...
revision = "1338221caf81"
down_revision = "648d99c5c414"
branch_labels = None
depends_on = None
...
def upgrade_rdr():
    ...
    op.replace_sp(sp_get_questionnaire_answers, replaces="ed28b84f061e.sp_get_questionnaire_answers")
    # ### end Alembic commands ###


def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.replace_sp(sp_get_questionnaire_answers, replace_with="ed28b84f061e.sp_get_questionnaire_answers")
    # ### end Alembic commands ###
