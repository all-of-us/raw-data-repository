...
def upgrade_rdr():
    ...
    try:
        ...
        # The participant_data_to_tactis table and triggers were already created in Stable.
        # If the table already exists, just ignore the exception to avoid a conflict during deployment
        pass
