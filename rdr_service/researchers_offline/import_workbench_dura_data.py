...
class WorkbenchDuraImporter:
    ...
    def create_dura_record(self, record, current_timestamp: str):
        return WorkbenchInstitutionalDura(
            ...
            zip=record.get('zip'),
            original_dura_completion=record.get('original_dura_completion'),
            dura_type_active=record.get('dura_type_active'),
            currentdura_agreementstatus=record.get('currentdura_agreementstatus'),
            currentdura_closed_reason=record.get('currentdura_closed_reason'),
            currentdura_other_reason=record.get('currentdura_other_reason'),
            currentdura_peerconfirmationdate=record.get('currentdura_peerconfirmationdate'),
            peer_contract_number=record.get('peer_contract_number'),
            agreement_expiration_date=record.get('agreement_expiration_date'),
            registration_form_checklist___1=record.get('registration_form_checklist___1'),
            registration_form_checklist___2=record.get('registration_form_checklist___2'),
            registration_form_checklist___3=record.get('registration_form_checklist___3'),
            registration_form_checklist___4=record.get('registration_form_checklist___4'),
            dura_checklist___1=record.get('dura_checklist___1'),
            dura_checklist___2=record.get('dura_checklist___2'),
            dura_checklist___3=record.get('dura_checklist___3'),
            dura_checklist___4=record.get('dura_checklist___4'),
            dura_checklist_3___1=record.get('dura_checklist_3___1'),
            dura_checklist_3___2=record.get('dura_checklist_3___2'),
            dura_checklist_3___3=record.get('dura_checklist_3___3'),
            additional_notes_checklist=record.get('additional_notes_checklist'),
            dura_amendment=record.get('dura_amendment'),
            executedrider_ct=record.get('executedrider_ct'),
            currentdura_document_status___1=record.get('currentdura_document_status___1'),
            currentdura_document_status___2=record.get('currentdura_document_status___2'),
            currentdura_registration_form_checklist___1=record.get('currentdura_registration_form_checklist___1'),
            currentdura_registration_form_checklist___2=record.get('currentdura_registration_form_checklist___2'),
            currentdura_registration_form_checklist___3=record.get('currentdura_registration_form_checklist___3'),
            currentdura_registration_form_checklist___4=record.get('currentdura_registration_form_checklist___4'),
            currentdura_dura_checklist___1=record.get('currentdura_dura_checklist___1'),
            currentdura_dura_checklist___2=record.get('currentdura_dura_checklist___2'),
            currentdura_dura_checklist___3=record.get('currentdura_dura_checklist___3'),
            currentdura_dura_checklist___4=record.get('currentdura_dura_checklist___4'),
            currentdura_dura_checklist_3___1=record.get('currentdura_dura_checklist_3___1'),
            currentdura_dura_checklist_3___2=record.get('currentdura_dura_checklist_3___2'),
            currentdura_dura_checklist_3___3=record.get('currentdura_dura_checklist_3___3'),
            currentdura_additional_notes_checklist=record.get('currentdura_additional_notes_checklist'),
            currentdura_executeddura=record.get('currentdura_executeddura'),
            currentdura_dura_amendment=record.get('currentdura_dura_amendment'),
            ror_id=record.get('ror_id'),
            tier_access___3=record.get('tier_access___3'),
            tier_access___4=record.get('tier_access___4'),
            new_rtctctecho_dura_documentation_complete=record.get('new_rtctctecho_dura_documentation_complete')
        )
