...
class DataGenerator:
    ...
    def create_database_genomic_long_read(self, **kwargs):
        m = self._genomic_long_read(**kwargs)
        self._commit_to_database(m)
        return m
    ...
    def create_database_genomic_proteomics(self, **kwargs):
        m = self._genomic_proteomics(**kwargs)
        self._commit_to_database(m)
        return m
    ...
    @staticmethod
    def _genomic_proteomics_p2_raw(**kwargs):
        return GenomicP2Raw(**kwargs)

    def create_database_genomic_proteomics_p2_raw(self, **kwargs):
        m = self._genomic_proteomics_p2_raw(**kwargs)
        self._commit_to_database(m)
        return m
