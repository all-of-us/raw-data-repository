...
class HPOGen(BaseGen):
  ...
  """
                    ...
                    for site in sites:
                        ...
                        if site["Anticipated Launch Date"]:
                            try:
                                ...
                                _logger.debug(
                                    "skipping {0}, invalid launch date".format(site["Site ID / Google Group"])
                                )
                                continue
                        ...
                        if site["MayoLINK Client #"]:
                            try:
                                ...
                                _logger.debug(
                                    "skipping {0}, invalid mayolink client id".format(site["Site ID / Google Group"])
                                )
                                continue
    ...
    :return: dict
    """
        data = [{"primary": True, "organization": {"reference": "Organization/{0}".format(self.id)}}]
