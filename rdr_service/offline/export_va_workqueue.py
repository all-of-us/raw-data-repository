...
def generate_workqueue_report():
    ...
    for participant in participants:
        ...
        participant_row = [participant_filtered.get("lastName", ""),
                           ...
                           _export_datetime(participant_filtered.get("physicalMeasurementsFinalizedTime")),
                           ...
                           _export_datetime(participant_filtered.get("sampleStatus1SST8Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1PST8", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1PST8Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1HEP4", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1HEP4Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1ED02", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1ED02Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1ED04", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1ED04Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1ED10", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1ED10Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus2ED10", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus2ED10Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1CFD9", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1CFD9Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1PXR2", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1PXR2Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1UR10", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1UR10Time")),
                           SAMPLE_STATUS.get(participant_filtered.get("sampleStatus1UR90", "UNSET")),
                           _export_datetime(participant_filtered.get("sampleStatus1UR90Time")),
