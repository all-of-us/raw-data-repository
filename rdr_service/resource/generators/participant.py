...
class ParticipantSummaryGenerator(generators.BaseGenerator):
    ...
    def _prep_participant_profile(self, p_id, ro_session):
        ...
        ps = ro_session.query(ParticipantSummary.ehrStatus,
                              ...
                              ParticipantSummary.enrollmentStatusParticipantV3_2Time,
                              ParticipantSummary.enrollmentStatusParticipantPlusEhrV3_2Time,
                              ParticipantSummary.enrollmentStatusEnrolledParticipantV3_2Time,
                              ParticipantSummary.enrollmentStatusCoreMinusPmV3_2Time,
                              ParticipantSummary.enrollmentStatusCoreV3_2Time,
        ...
        if not ps.enrollmentStatus:
            ...
            data = {
                ...
                'enrollment_status_v3_1': str(ps.enrollmentStatusV3_2),
                'enrollment_status_v3_1_id': int(ps.enrollmentStatusV3_2),
                'enrollment_status_v3_1_participant_time': ps.enrollmentStatusParticipantV3_2Time,
                'enrollment_status_v3_1_participant_plus_ehr_time': ps.enrollmentStatusParticipantPlusEhrV3_2Time,
                'enrollment_status_v3_1_participant_plus_basics_time': ps.enrollmentStatusEnrolledParticipantV3_2Time,
                'enrollment_status_v3_1_core_minus_pm_time': ps.enrollmentStatusCoreMinusPmV3_2Time,
                'enrollment_status_v3_1_core_time': ps.enrollmentStatusCoreV3_2Time,
