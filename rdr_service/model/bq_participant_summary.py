...
from rdr_service.model.bq_base import BQField, BQFieldModeEnum, BQFieldTypeEnum, BQRecordField, BQSchema, BQTable
...
class BQAddressSchema(BQSchema):
  ...
  """
    ...
    addr_type = BQField(
        "addr_type", BQFieldTypeEnum.STRING, BQFieldModeEnum.REQUIRED, fld_enum=BQStreetAddressTypeEnum
    )
    addr_type_id = BQField(
        "addr_type_id", BQFieldTypeEnum.INTEGER, BQFieldModeEnum.REQUIRED, fld_enum=BQStreetAddressTypeEnum
    )
...
class BQModuleStatusSchema(BQSchema):
  ...
  """
    ...
    mod_status_id = BQField(
        "mod_status_id", BQFieldTypeEnum.INTEGER, BQFieldModeEnum.NULLABLE, fld_enum=BQModuleStatusEnum
    )
...
class BQParticipantSummarySchema(BQSchema):
  ...
  """
    ...
    withdrawal_reason_justification = BQField(
        "withdrawal_reason_justification", BQFieldTypeEnum.STRING, BQFieldModeEnum.NULLABLE
    )
