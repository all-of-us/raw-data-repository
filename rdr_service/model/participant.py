...
class ParticipantBase:
    ...
    participantId = mapped_column("participant_id", Integer, autoincrement=False, primary_key=True)
    """
...
class Participant(ParticipantBase, Base):
    ...
    __mapper_args__ = {"primary_key": 'participantId'}
...
class ParticipantHistory(ParticipantBase, Base):
    ...
    version = mapped_column("version", Integer, primary_key=True)
    __mapper_args__ = {"primary_key": ['participantId', 'version']}
