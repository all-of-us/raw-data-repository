...
class ParticipantBase(object):
    ...
    participantId = Column("participant_id", Integer, autoincrement=False)
    """
...
class Participant(ParticipantBase, Base):
    ...
    __mapper_args__ = {"primary_key": ParticipantBase.participantId}
...
class ParticipantHistory(ParticipantBase, Base):
    ...
    __mapper_args__ = {"primary_key": [ParticipantBase.participantId, version]}
