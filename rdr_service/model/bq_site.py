...
class BQInPersonOperationsStatus(Enum):
...
class BQSiteSchema(BQSchema):
    ...
    in_person_operations_status = BQField('in_person_operations_status', BQFieldTypeEnum.STRING,
                                          BQFieldModeEnum.NULLABLE, fld_enum=BQInPersonOperationsStatus)
    in_person_operations_status_id = BQField('in_person_operations_status_id', BQFieldTypeEnum.INTEGER,
                                             BQFieldModeEnum.NULLABLE, fld_enum=BQInPersonOperationsStatus)
