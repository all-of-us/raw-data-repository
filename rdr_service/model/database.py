...
from rdr_service.model.genomics import GenomicSet, GenomicSetMember, GenomicAW5Raw
...
from rdr_service.model.ppsc_data_transfer import PPSCDataTransferAuth
...
class Database(object):
    ...
    def create_cdm_schema(self):
        CdmBase.metadata.create_all(self._engine)
