...
from rdr_service.code_constants import CITY_QUESTION_CODE, CONSENT_FOR_DVEHR_MODULE, \
  CONSENT_FOR_ELECTRONIC_HEALTH_RECORDS_MODULE, CONSENT_FOR_STUDY_ENROLLMENT_MODULE, \
  DATE_OF_BIRTH_QUESTION_CODE, \
  EDUCATION_QUESTION_CODE, EMAIL_QUESTION_CODE, FAMILY_HISTORY_MODULE, FIRST_NAME_QUESTION_CODE, \
  GENDER_IDENTITY_QUESTION_CODE, HEALTHCARE_ACCESS_MODULE, INCOME_QUESTION_CODE, \
  LANGUAGE_QUESTION_CODE, \
  LAST_NAME_QUESTION_CODE, LIFESTYLE_PPI_MODULE, LOGIN_PHONE_NUMBER_QUESTION_CODE, \
  MEDICATIONS_MODULE, \
  MIDDLE_NAME_QUESTION_CODE, OVERALL_HEALTH_PPI_MODULE, PERSONAL_MEDICAL_HISTORY_MODULE, \
  PHONE_NUMBER_QUESTION_CODE, \
  RECONTACT_METHOD_QUESTION_CODE, SEXUAL_ORIENTATION_QUESTION_CODE, SEX_QUESTION_CODE, \
  STATE_QUESTION_CODE, \
