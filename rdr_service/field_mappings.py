...
FIELD_TO_QUESTIONNAIRE_MODULE_CODE = {
    ...
    CONSENT_FOR_GENOMICS_ROR_FIELD: CONSENT_FOR_GENOMICS_ROR,
...
QUESTIONNAIRE_MODULE_CODE_TO_FIELD = {v: k for k, v in list(FIELD_TO_QUESTIONNAIRE_MODULE_CODE.items())}
