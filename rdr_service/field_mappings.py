...
from rdr_service.code_constants import (
    ...
    EMOTIONAL_HEALTH_MODULE,
    BEHAVIORAL_HEALTH_MODULE,
...
QUESTION_CODE_TO_FIELD.update({
    PEDIATRIC_SEX_QUESTION_CODE: ('sexId', FieldType.CODE),
    PEDIATRIC_FIRST_NAME_QUESTION: ('firstName', FieldType.STRING),
    PEDIATRIC_MIDDLE_NAME_QUESTION: ('middleName', FieldType.STRING),
    PEDIATRIC_LAST_NAME_QUESTION: ('lastName', FieldType.STRING),
    PEDIATRIC_EMAIL: ('email', FieldType.STRING),
    PEDIATRIC_STREET1_ADDRESS: ('streetAddress', FieldType.STRING),
    PEDIATRIC_STREET2_ADDRESS: ('streetAddress2', FieldType.STRING),
    PEDIATRIC_CITY_ADDRESS: ('city', FieldType.STRING),
    PEDIATRIC_STATE_ADDRESS: ('stateId', FieldType.CODE),
    PEDIATRIC_ZIP_ADDRESS: ('zipCode', FieldType.STRING),
    PEDIATRIC_BIRTH_DATE: ('dateOfBirth', FieldType.DATE),
    PEDIATRIC_PHONE: ('loginPhoneNumber', FieldType.STRING)
})
...
FIELD_TO_QUESTIONNAIRE_MODULE_CODE = {
    ...
    QUESTIONNAIRE_ON_EMOTIONAL_HEALTH: EMOTIONAL_HEALTH_MODULE,
    QUESTIONNAIRE_ON_BEHAVIORAL_HEALTH: BEHAVIORAL_HEALTH_MODULE,
...
QUESTIONNAIRE_MODULE_CODE_TO_FIELD = {
    PEDIATRICS_OVERALL_HEALTH: QUESTIONNAIRE_ON_OVERALL_HEALTH_FIELD,
    PEDIATRICS_BASICS: QUESTIONNAIRE_ON_THE_BASICS_FIELD,
    PEDIATRIC_EHR_CONSENT: CONSENT_FOR_ELECTRONIC_HEALTH_RECORDS_FIELD,
    PEDIATRIC_PRIMARY_CONSENT_MODULE: CONSENT_FOR_STUDY_ENROLLMENT_FIELD
}
