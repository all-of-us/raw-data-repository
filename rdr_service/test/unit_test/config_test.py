...
class TestConfig(FlaskTestBase):
    ...
    def test_GET_config_by_date(self):
        ...
        with FakeClock(t1):
            ...
            self.assertEqual(conf, config.load(name).configuration)
        ...
        with FakeClock(t2):
            ...
            self.assertEqual(conf_A, config.load(name).configuration)
            ...
            self.assertEqual(response_B, config.load(name, date=t1).configuration)
