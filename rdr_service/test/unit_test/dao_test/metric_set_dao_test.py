...
class MetricSetDaoTest(SqlTestBase):
    ...
    def test_get(self):
        ...
        agg = AggregateMetrics(metricSetId=ms.metricSetId, metricsKey=MetricsKey.GENDER, value="female", count=123)
    ...
    def test_get_all_for_metric_set(self):
        ...
        agg1 = AggregateMetrics(metricSetId=ms1.metricSetId, metricsKey=MetricsKey.GENDER, value="female", count=123)
        agg2 = AggregateMetrics(metricSetId=ms2.metricSetId, metricsKey=MetricsKey.GENDER, value="male", count=987)
    ...
    def test_delete_all_for_metric_set(self):
        ...
        self.aggregate_metrics_dao.insert(
            AggregateMetrics(metricSetId=ms1.metricSetId, metricsKey=MetricsKey.GENDER, value="female", count=123)
        )
        self.aggregate_metrics_dao.insert(
            AggregateMetrics(metricSetId=ms2.metricSetId, metricsKey=MetricsKey.GENDER, value="male", count=987)
        )
