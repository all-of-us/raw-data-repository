...
class EhrReceiptDaoTest(SqlTestBase):
    ...
    def _setup_initial_data(self):
        ...
        self.participants = {
            participant.participantId: participant for participant, summary in participant_and_summary_pairs
        }
        self.summaries = {participant.participantId: summary for participant, summary in participant_and_summary_pairs}
    ...
    def test_get_active_organization_counts_in_interval_day(self):
        ...
        results = self.ehr_receipt_dao.get_active_organization_counts_in_interval(
            start_date=datetime.datetime(2019, 2, 1), end_date=datetime.datetime(2019, 2, 7), interval=INTERVAL_DAY
        )
    ...
    def test_get_active_organization_counts_in_interval_week(self):
        ...
        results = self.ehr_receipt_dao.get_active_organization_counts_in_interval(
            start_date=datetime.datetime(2019, 2, 1), end_date=datetime.datetime(2019, 3, 1), interval=INTERVAL_WEEK
        )
    ...
    def test_get_active_organization_counts_in_interval_month(self):
        ...
        results = self.ehr_receipt_dao.get_active_organization_counts_in_interval(
            start_date=datetime.datetime(2019, 1, 1), end_date=datetime.datetime(2019, 5, 1), interval=INTERVAL_MONTH
        )
