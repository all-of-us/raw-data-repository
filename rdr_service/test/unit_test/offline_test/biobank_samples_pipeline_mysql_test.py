...
class MySqlReconciliationTest(FlaskTestBase):
    ...
    def _submit_race_questionnaire_response(self, participant_id, race_answers):
        ...
        qr = make_questionnaire_response_json(participant_id, self._questionnaire_id, code_answers=code_answers)
    ...
    def test_reconciliation_query(self):
        ...
        self.assertItemsEqual(multi_sample_row["sent_order_id"].split(","), ["ORepeatedOrder2"])
