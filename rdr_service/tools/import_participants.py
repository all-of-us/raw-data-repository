...
from rdr_service.code_constants import CONSENT_FOR_ELECTRONIC_HEALTH_RECORDS_MODULE, \
  CONSENT_FOR_STUDY_ENROLLMENT_MODULE, DATE_OF_BIRTH_QUESTION_CODE, EMAIL_QUESTION_CODE, \
  FIRST_NAME_QUESTION_CODE, \
  GENDER_IDENTITY_QUESTION_CODE, LAST_NAME_QUESTION_CODE, LIFESTYLE_PPI_MODULE, \
  OVERALL_HEALTH_PPI_MODULE, PPI_SYSTEM, \
  THE_BASICS_PPI_MODULE, ZIPCODE_QUESTION_CODE
