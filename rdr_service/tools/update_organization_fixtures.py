...
def main(source, destination):
  ...
  """
    copy_file(os.path.join(source, "awardees.csv"), os.path.join(destination, "awardees.csv"))
    copy_file(os.path.join(source, "organizations.csv"), os.path.join(destination, "organizations.csv"))
    copy_sanitized_csv(
