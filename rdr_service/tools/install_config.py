...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", help="Path to the config.  If omitted, the server config will be printed.")
    parser.add_argument(
        "--instance",
        type=str,
    ...
    parser.add_argument("--update", help="If this flag is set, then update the remote server", action="store_true")
