    ...
    def _export_aliquot_data_as_csv(cls, data_to_export: List[AliquotData]):
        with open('aliquot_export.csv', 'w') as file:
            writer = csv.DictWriter(file, [
                ...
                'rna_mass',
                'rna_mass_units',
                'total_rna_concentration',
                'total_rna_concentration_units',
                '260/230_ratio',
                '260/280_ratio',
                'freeze_thaw_count',
                'treatment_type',
            ...
            for data in data_to_export:
                writer.writerow({
                    ...
                    'rna_mass': data.total_rna_mass,
                    'rna_mass_units': 'ng',
                    'total_rna_concentration': data.total_rna_concentration,
                    'total_rna_concentration_units': data.total_rna_concentration_units,
