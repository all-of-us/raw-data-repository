...
def generate_fake_data(client, args):
    ...
    while total_participants_created < args.num_participants:
        participants_for_batch = min(MAX_PARTICIPANTS_PER_REQUEST, args.num_participants - total_participants_created)
        request_body = {
...
if __name__ == "__main__":
    ...
    if (
        rdr_client.args.num_participants == 0
        and not rdr_client.args.create_biobank_samples
        and not rdr_client.args.create_samples_from_file
    ):
