...
from rdr_service.singletons import SITE_CACHE_INDEX
...
class SiteDao(CacheAllDao):
    def __init__(self):
        super(SiteDao, self).__init__(
            Site, cache_index=SITE_CACHE_INDEX, cache_ttl_seconds=600, index_field_keys=["googleGroup"]
        )
