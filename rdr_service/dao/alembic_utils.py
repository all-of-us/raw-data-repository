...
def create_view(operations, operation):
    operations.execute("CREATE VIEW `{0}` AS {1}".format(operation.target.name, operation.target.sqltext))
...
def create_sp(operations, operation):
    operations.execute("CREATE PROCEDURE `{0}` {1}".format(operation.target.name, operation.target.sqltext))
...
def create_fn(operations, operation):
    operations.execute("CREATE FUNCTION `{0}` {1}".format(operation.target.name, operation.target.sqltext))
