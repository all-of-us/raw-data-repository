...
[main.py](main.py) - defines the endpoints exposed in our REST API; this code is run once at startup

[api/](api) - contains the API classes for our REST API endpoints; referenced by main.py

[alembic/](alembic) - contains schema migrations generated by Alembic to update our database

[tools/](tools) - contains command line tools used to set up your environment, update server 
configuration and various data in our databases

[offline/](offline) - contains code that runs in a separate service from our REST API, as asynchronous jobs

[offline/main.py](offline/main.py) - defines the endpoints used to start offline jobs
