...
from model.bq_participant_summary import BQRaceSchema, BQGenderSchema, BQModuleStatusSchema, BQConsentSchema
...
class BQPDRParticipantSummarySchema(BQSchema):
  ...
  ubr_sexual_gender_minority = BQField('ubr_sexual_gender_minority', BQFieldTypeEnum.INTEGER, BQFieldModeEnum.NULLABLE)
