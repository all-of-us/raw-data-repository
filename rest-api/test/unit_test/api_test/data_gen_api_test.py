...
class DataGenApiTest(testutil.CloudStorageTestBase, FlaskTestBase):
  ...
  def test_generate_samples(self):
    ...
    self.assertEquals(15, len(bo_dao.get_with_children(order.biobankOrderId).samples))
    ...
    self.assertEquals(15, BiobankStoredSampleDao().count())
    ...
    self.assertEquals(12, ps.numBaselineSamplesArrived)
