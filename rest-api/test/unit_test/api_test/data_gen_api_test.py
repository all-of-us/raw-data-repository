...
class DataGenApiTest(testutil.CloudStorageTestBase, FlaskTestBase):
  ...
  def test_generate_samples(self):
    ...
    self.assertEquals(13, len(bo_dao.get_with_children(order.biobankOrderId).samples))
    ...
    self.assertEquals(13, BiobankStoredSampleDao().count())
    ...
    self.assertEquals(11, ps.numBaselineSamplesArrived)
