...
class ParticipantSummaryApiTest(FlaskTestBase):
  ...
  def create_expected_response(self, participant, answers, consent_language=None,
                               patient_statuses=None):
  ...
  def test_get_summary_with_patient_status(self):
    ...
    # the same
    expected = self.create_expected_response(participant, answers, consent_language='es',
                                             patient_statuses=[summary_status_dict])
  ...
  def test_member_ordered_stored_times_for_biobank_order_cancel(self):
    ...
    path = 'Participant/%s/BiobankOrder' % to_client_participant_id(int(participant_id_1[1:])) + \
           '/' + biobank_order_id
    request_data = {
    ...
    self.assertEquals(ps_1.get('biospecimenFinalizedSite'), 'UNSET')
    self.assertEquals(ps_1.get('biospecimenCollectedSite'), 'UNSET')
