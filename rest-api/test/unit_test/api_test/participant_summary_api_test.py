...
class ParticipantSummaryApiTest(FlaskTestBase):
  ...
  def testQuery_manyParticipants(self):
    ...
    questionnaire_id_4 = self.create_questionnaire('all_consents_questionnaire.json')
    ...
    participant_4 = self.send_post('Participant', {})
    participant_id_3 = participant_3['participantId']
    participant_id_4 = participant_4['participantId']
    with FakeClock(TIME_1):
      self.send_consent(participant_id_1)
      self.send_consent(participant_id_2)
      self.send_consent(participant_id_3)
      self.send_consent(participant_id_4)
    ...
    self.submit_questionnaire_response(participant_id_4, questionnaire_id,
                                       RACE_NONE_OF_THESE_CODE, "male",
                                       "John", "S", "Jamison", "78752", None,
                                       None, None, None, None, None, None, None, None, None,
                                       datetime.date(1978, 10, 11), None)
    ...
    self._submit_consent_questionnaire_response(participant_id_3, questionnaire_id_3,
                                                CONSENT_PERMISSION_YES_CODE)
    self._submit_consent_questionnaire_response(participant_id_4, questionnaire_id_4,
                                                CONSENT_PERMISSION_YES_CODE)
    ...
    self._submit_empty_questionnaire_response(participant_id_4, questionnaire_id_4)
    ...
    measurements_4 = load_measurement_json(participant_id_4, TIME_1.isoformat())
    path_2 = 'Participant/%s/PhysicalMeasurements' % participant_id_2
    path_3 = 'Participant/%s/PhysicalMeasurements' % participant_id_3
    path_4 = 'Participant/%s/PhysicalMeasurements' % participant_id_4
    with FakeClock(TIME_2):
      ...
      self.send_post(path_4, measurements_4)
    ...
    # Store samples for DNA for participants 1, 3, and 4
    ...
    self._store_biobank_sample(participant_4, '1ED10')
    self._store_biobank_sample(participant_4, '1SAL2')
    self._store_biobank_sample(participant_4, '1SAL')
    ...
    participant_4 = self.send_get('Participant/%s' % participant_id_4)
    ...
    with FakeClock(TIME_3):
      ...
      participant_4['site'] = 'hpo-site-monroeville'
      ...
      self.send_put('Participant/%s' % participant_id_4, participant_4,
                    headers={'If-Match': participant_4['meta']['versionId']})

    with FakeClock(TIME_4):
      ps_1 = self.send_get('Participant/%s/Summary' % participant_id_1)
      ps_2 = self.send_get('Participant/%s/Summary' % participant_id_2)
      ps_3 = self.send_get('Participant/%s/Summary' % participant_id_3)
      ps_4 = self.send_get('Participant/%s/Summary' % participant_id_4)

    self.assertEquals('SUBMITTED', ps_4['consentForElectronicHealthRecords'])
    ...
    with FakeClock(TIME_4):
      response = self.send_get('ParticipantSummary')
      self.assertBundle([_make_entry(ps_4), _make_entry(ps_1), _make_entry(ps_2), _make_entry(
        ps_3)], response)

      self.assertResponses('ParticipantSummary?_count=2', [[ps_4, ps_1], [ps_2, ps_3]])
...
#                           [[ps_4]]) # @TODO: make ps_4 full participant
    ...
    with FakeClock(TIME_5):
      self.assertResponses('ParticipantSummary?_count=2&_sort=firstName',
                           [[ps_1, ps_3], [ps_4, new_ps_2]])
      self.assertResponses('ParticipantSummary?_count=2&_sort:asc=firstName',
                           [[ps_1, ps_3], [ps_4, new_ps_2]])
      self.assertResponses('ParticipantSummary?_count=2&_sort:desc=firstName',
                           [[new_ps_2, ps_4], [ps_3, ps_1]])
      self.assertResponses('ParticipantSummary?_count=2&_sort=dateOfBirth',
                           [[new_ps_2, ps_1], [ps_3, ps_4]])
      self.assertResponses('ParticipantSummary?_count=2&_sort:desc=dateOfBirth',
                           [[ps_4, ps_3], [ps_1, new_ps_2]])
      self.assertResponses('ParticipantSummary?_count=2&_sort=genderIdentity',
                           [[ps_4, ps_1], [ps_3, new_ps_2]])
      self.assertResponses('ParticipantSummary?_count=2&_sort:desc=genderIdentity',
                           [[new_ps_2, ps_4], [ps_1, ps_3]])
      self.assertResponses('ParticipantSummary?_count=2&_sort=questionnaireOnTheBasics',
                           [[ps_4, ps_1], [new_ps_2, ps_3]])
      self.assertResponses('ParticipantSummary?_count=2&_sort=hpoId',
                           [[ps_4, ps_1], [new_ps_2, ps_3]])
      self.assertResponses('ParticipantSummary?_count=2&_sort:desc=hpoId',
                           [[ps_4, ps_1], [new_ps_2, ps_3]])
