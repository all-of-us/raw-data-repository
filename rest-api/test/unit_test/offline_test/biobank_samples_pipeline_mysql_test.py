...
class MySqlReconciliationTest(FlaskTestBase):
  ...
  def test_reconciliation_query(self):
    ...
    self.setup_codes([RACE_AIAN_CODE, RACE_WHITE_CODE,
                      "AIANSpecific_AmericanIndian",
                      "AIANSpecific_AlaskaNative",
                      "AIANSpecific_CentralSouthAmericanIndian",
                      "AIANSpecific_AIANNoneOfTheseDescribeMe"],
                     CodeType.ANSWER)
    ...
    p_old_on_time = self._insert_participant(race_codes=["AIANSpecific_AmericanIndian"])
    ...
    p_withdrawn_old_on_time = self._insert_participant(race_codes=["AIANSpecific_AmericanIndian"])
