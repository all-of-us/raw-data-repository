...
QUESTIONNAIRE_ON_PERSONAL_HABITS_FIELD = "questionnaireOnPersonalHabits"
QUESTIONNAIRE_ON_SOCIODEMOGRAPHICS_FIELD = "questionnaireOnSociodemographics"
...
FIELD_TO_QUESTIONNAIRE_MODULE_CODE = {
  ...
  QUESTIONNAIRE_ON_PERSONAL_HABITS_FIELD: PERSONAL_HABITS_PPI_MODULE,
  QUESTIONNAIRE_ON_SOCIODEMOGRAPHICS_FIELD: SOCIODEMOGRAPHIC_PPI_MODULE
