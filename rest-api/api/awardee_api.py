...
class AwardeeApi(BaseApi):
  ...
  def _make_resource_url(self, response_json, id_field, participant_id):   # pylint: disable=unused-argument
    import main
    return main.api.url_for(self.__class__, a_id=response_json[id_field],
                            _external=True)
