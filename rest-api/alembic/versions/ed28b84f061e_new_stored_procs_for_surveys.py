...
CREATE PROCEDURE sp_get_code_module_items
...
sp_get_questionnaire_answers = """
  CREATE PROCEDURE sp_get_questionnaire_answers
...
def upgrade_rdr():
    ...
    op.execute(sp_get_code_module_items)
    op.execute(sp_get_questionnaire_answers)
    # ### end Alembic commands ###


def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute('DROP PROCEDURE IF EXISTS sp_get_code_module_items')
    op.execute('DROP PROCEDURE IF EXISTS sp_get_questionnaire_answers')
    # ### end Alembic commands ###
