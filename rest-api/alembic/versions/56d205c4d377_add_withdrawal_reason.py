...
Revision ID: 56d205c4d377
Revises: 380d2c363481
Create Date: 2018-10-09 11:24:17.106673
...
def upgrade_rdr():
    ...
    op.add_column('participant', sa.Column('withdrawal_reason', sa.String(length=80), nullable=True))
    op.add_column('participant', sa.Column('withdrawal_reason_justification', sa.UnicodeText(), nullable=True))
    op.add_column('participant_history', sa.Column('withdrawal_reason', sa.String(length=80), nullable=True))
