...
def upgrade():
    ...
    op.create_index('participant_summary_hpo_status', 'participant_summary', ['hpo_id', 'enrollment_status'], unique=False)
    op.create_index('participant_summary_hpo_withdrawal_status_time', 'participant_summary', ['hpo_id', 'withdrawal_status', 'withdrawal_time'], unique=False)
