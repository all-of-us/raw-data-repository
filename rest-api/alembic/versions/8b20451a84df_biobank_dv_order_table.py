...
def upgrade_rdr():
    ...
    sa.Column('created', mysql.DATETIME(fsp=6), server_default=sa.text(u'now()'), nullable=False),
    sa.Column('modified', mysql.DATETIME(fsp=6), server_default=sa.text(u'now()'), nullable=False),
