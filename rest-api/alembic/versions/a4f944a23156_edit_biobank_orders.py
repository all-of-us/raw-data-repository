...
Revision ID: a4f944a23156
Revises: 075b9eee88b7
Create Date: 2018-08-13 10:24:26.564252
...
def upgrade_rdr():
    ...
    op.add_column('biobank_order', sa.Column('cancelled_order', sa.Boolean(), nullable=True))
...
def downgrade_rdr():
    ...
    op.drop_column('biobank_order', 'cancelled_order')
