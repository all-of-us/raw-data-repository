...
def upgrade_rdr():
    ...
    op.add_column('biobank_history', sa.Column('finalized_time', model.utils.UTCDateTime(), nullable=True))
    op.add_column('biobank_order', sa.Column('finalized_time', model.utils.UTCDateTime(), nullable=True))
