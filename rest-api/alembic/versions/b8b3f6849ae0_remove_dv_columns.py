...
Revision ID: b8b3f6849ae0
Revises: 03bdb0a44083
Create Date: 2019-03-25 14:43:17.112652
...
def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('participant_summary', sa.Column('sample_status_dv_1sal2_time', mysql.DATETIME(), nullable=True))
    op.add_column('participant_summary', sa.Column('sample_order_status_dv_1sal2', mysql.SMALLINT(display_width=6), autoincrement=False, nullable=True))
    op.add_column('participant_summary', sa.Column('sample_status_dv_1sal2', mysql.SMALLINT(display_width=6), autoincrement=False, nullable=True))
    op.add_column('participant_summary', sa.Column('sample_order_status_dv_1sal2_time', mysql.DATETIME(), nullable=True))
    # ### end Alembic commands ###
