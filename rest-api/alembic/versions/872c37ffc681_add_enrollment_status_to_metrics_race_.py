...
def upgrade_rdr():
    ...
    op.execute('ALTER TABLE metrics_race_cache ADD COLUMN registerd_flag BOOLEAN NOT NULL AFTER `date_inserted`;')
    op.execute('ALTER TABLE metrics_race_cache ADD COLUMN consent_flag BOOLEAN NOT NULL AFTER `registerd_flag`;')
    ...
    op.execute('ALTER TABLE metrics_race_cache ADD PRIMARY KEY (`date_inserted`,`registerd_flag`,`consent_flag`,`core_flag`,`hpo_id`,`hpo_name`,`date`)')
    # ### end Alembic commands ###


def downgrade_rdr():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('metrics_race_cache', 'registerd_flag')
