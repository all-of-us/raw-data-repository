...
def upgrade():
    ...
    op.create_index('questionnaire_concept_system_code', 'questionnaire_concept', ['concept_system', 'concept_code'], unique=False)
    ...
    sa.Column('ethnicity', model.utils.Enum(Ethnicity), nullable=True),
...
def downgrade():
    ...
    op.drop_index('questionnaire_question_system_code', table_name='questionnaire_question')
    op.drop_table('questionnaire_question')
    op.drop_index('questionnaire_concept_system_code', table_name='questionnaire_concept')
