...
def upgrade_rdr():
    ...
    try:
      ...
      # do nothing is column already exist
      pass
    try:
      ...
      pass
    try:
      op.execute('ALTER TABLE questionnaire_response ADD COLUMN questionnaire_semantic_version varchar(100) AFTER `questionnaire_version`;')
    except OperationalError:
      pass
