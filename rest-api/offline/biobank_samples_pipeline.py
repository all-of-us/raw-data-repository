...
EXPECTED_HEADERS = [
  ...
  'Sample Type',
  'Sample Treatments',
  'Parent Expected Volume',
  'Sample Quantity',
  'Sample Container Type',
  'Sample Family Collection Date',
  'Sample Disposal Status',
  'Sample Disposed Date',
  'Parent Sample Id',
...
def reduce_samples(biobank_id, samples):
  ...
  if not participant_id:
    print "Participant with biobank ID {} not found; skipping.".format(biobank_id)
    return
